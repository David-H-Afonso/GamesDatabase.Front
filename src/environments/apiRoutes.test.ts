...
describe('apiRoutes — dynamic builders', () => {
	...
	it('dataExport.deleteDuplicateGame(12) returns /DataExport/duplicate-games/12', () => expect(apiRoutes.dataExport.deleteDuplicateGame(12)).toBe('/DataExport/duplicate-games/12'))
})
