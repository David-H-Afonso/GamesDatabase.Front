...
export const fetchGameViews = createAsyncThunk('gameViews/fetchGameViews', async (params: GameViewQueryParameters = {}, { rejectWithValue }) => {
	try {
...
export const fetchPublicGameViews = createAsyncThunk('gameViews/fetchPublicGameViews', async (_, { rejectWithValue }) => {
	try {
...
export const fetchGameViewById = createAsyncThunk('gameViews/fetchGameViewById', async (id: number, { rejectWithValue }) => {
	try {
...
// Create new GameView
export const createGameViewThunk = createAsyncThunk('gameViews/createGameView', async (gameViewData: GameViewCreateDto, { rejectWithValue }) => {
	try {
...
export const updateGameViewThunk = createAsyncThunk(
	...
	async ({ id, gameViewData }: { id: number; gameViewData: GameViewUpdateDto }, { rejectWithValue }) => {
		try {
...
export const deleteGameViewThunk = createAsyncThunk('gameViews/deleteGameView', async (id: number, { rejectWithValue }) => {
	try {
