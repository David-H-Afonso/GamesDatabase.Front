...
import { getGamePlayedStatuses, getActiveGamePlayedStatuses, createGamePlayedStatus, updateGamePlayedStatus, deleteGamePlayedStatus, getGamePlayedStatusById } from '@/services'
...
export const fetchPlayedStatuses = createAsyncThunk('gamePlayedStatus/fetchPlayedStatuses', async (params: QueryParameters = {}, { rejectWithValue }) => {
	try {
...
export const fetchActivePlayedStatuses = createAsyncThunk('gamePlayedStatus/fetchActivePlayedStatuses', async (_, { rejectWithValue }) => {
	try {
...
export const createPlayedStatus = createAsyncThunk('gamePlayedStatus/createPlayedStatus', async (data: GamePlayedStatusCreateDto, { rejectWithValue }) => {
	try {
...
export const deletePlayedStatus = createAsyncThunk('gamePlayedStatus/deletePlayedStatus', async (id: number, { rejectWithValue }) => {
	try {
