...
export const fetchGameById = createAsyncThunk('games/fetchGameById', async (id: number, { rejectWithValue }) => {
	try {
...
export const createGame = createAsyncThunk('games/createGame', async (gameData: GameCreateDto, { rejectWithValue }) => {
	try {
...
export const updateGame = createAsyncThunk('games/updateGame', async ({ id, gameData }: { id: number; gameData: GameUpdateDto }, { rejectWithValue }) => {
	try {
...
export const bulkUpdateGames = createAsyncThunk('games/bulkUpdateGames', async (data: BulkUpdateGameDto, { rejectWithValue }) => {
	try {
