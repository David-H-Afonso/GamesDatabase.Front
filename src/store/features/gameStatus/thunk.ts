...
export const fetchStatuses = createAsyncThunk('gameStatus/fetchStatuses', async (params: QueryParameters = {}, { rejectWithValue }) => {
	try {
...
export const fetchActiveStatuses = createAsyncThunk('gameStatus/fetchActiveStatuses', async (_, { rejectWithValue }) => {
	try {
...
export const fetchSpecialStatuses = createAsyncThunk('gameStatus/fetchSpecialStatuses', async (_, { rejectWithValue }) => {
	try {
...
// Create a new status
export const createStatus = createAsyncThunk('gameStatus/createStatus', async (statusData: GameStatusCreateDto, { rejectWithValue }) => {
	try {
...
export const updateStatus = createAsyncThunk('gameStatus/updateStatus', async ({ id, statusData }: { id: number; statusData: GameStatusUpdateDto }, { rejectWithValue }) => {
	try {
...
// Delete status by id
export const deleteStatus = createAsyncThunk('gameStatus/deleteStatus', async (id: number, { rejectWithValue }) => {
	try {
